<template>
  <div id="app">
    <h4 class="my-4 uppercase text-3xl">Rate and Review the product</h4>
    ...
    <form action="#" @submit.prevent="store" class="custom-form">
      ...
      <div class="flex justify-between">
        <div class="flex self-center my-6">
          <button
            class="w-48 no-underline bg-blue-500 px-4 py-2 text-black rounded uppercase hover:shadow-lg">Submit</button>
        </div>
      </div>
    </form>
  </div>
