  ...
  <div class="ml-8 bg-white">
    <div class="w-full  p-6">
      ...
      <div class="flex justify-end mb-3">
        <a href="#" class="button is-info is-medium hover:shadow-lg no-underline btnstyle"
          @click="add()">Add</a>
      </div>
        ...
        <form action="" @submit.prevent="store" class="w-full">
          ...
          <div class="flex justify-between">
            <div class="flex self-center my-6">
              <button
                class="button is-info is-medium hover:shadow-lg btnstyle">Submit</button>
        ...
        <div class="">
          ...
          <div class="flex flex-wrap">
            <div v-for="address in addresses" class="w-1/2  pr-5 my-3  h-full">
              <div class="px-3 py-2 bg-gray-200 border">
                <div class="flex justify-between">
                  <div>
                    <p class="my-2"><b>{{ address.name }} </b></p>
                    <p class="my-2">{{ address.address_1 }}, {{ address.address_2 }} </p>
                    <p class="my-2">{{ address.city.name }} - {{ address.postal_code }}</p>
        ...
        <form class="w-full">
            ...
            <div class="w-1/2">
              <div class="w-full field flex">
                ...
                <div class="control w-3/5">
                  ...
                  <select @change="citychanged" class="input-type my-2" v-model="editaddress.city">
          ...
          <div class="flex justify-between">
            <div class="flex self-center my-6">
              ...
              <a href="#" @click="showaddress()" class="rounded-full btnstyle">Show
                Address</a>
...
export default {
  ...
  methods: {
    ...
    async edit() {
      ...
      let response = await this.$axios.$post('addresses/update/' + this.editaddress.id, this.editaddress).then((response) => {
