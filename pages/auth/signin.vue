              ...
              <form action="" @submit.prevent="signin">
                  ...
                  <div class="w-full px-3 mb-5">
                    ...
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i
                          class="fa fa-envelope text-gray-400"></i></div>
                      <input type="email"
                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-red-200"
                ...
                <div class="flex mx-3">
                  <div class="w-full px-3 mb-10">
                    ...
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i
                          class="fa fa-lock text-gray-400"></i></div>
                      <input type="password"
                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-red-200"
                ...
                <div class="flex mx-3">
                  <div class="w-full px-3 mb-5">
                    <button
                      class="block w-full max-w-xs mx-auto secondary hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-full px-3 py-3 font-semibold">Login</button>
                  </div>
                </div>
