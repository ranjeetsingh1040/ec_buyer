              ...
              <form action="" @submit.prevent="resetPassword">
                ...
                <div class="flex mx-3">
                  <div class="w-full px-3 my-5 ">
                    <button type="submit"
                      class="block w-full max-w-xs mx-auto secondary hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-full px-3 py-3 font-semibold">
...
export default {
  ...
  methods: {
    async resetPassword() {
      ...
      // })
      const response = await this.$axios.$post('auth/reset-password', this.form).then((response) => {
