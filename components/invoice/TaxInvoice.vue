<template>
	<div class="container mx-auto flex justify-center">
		<div class="w-full lg:w-3/4 my-4" v-for="tax in taxdetails">
			<div class="mb-4 bg-gray-500 p-4">
				...
				<div class="w-full lg:w-5/6">
					<div class="flex flex-col lg:flex-row my-2">
						...
						<div class="w-full lg:w-1/3">
							...
							<p class="my-1">{{tax.address.city.name}}</p>
							<p class="my-1">{{tax.address.state.name}}-{{tax.address.postal_code}}</p>
						</div>
						<div class="w-full lg:w-1/3">
					...
					<div class="w-full border-b border-gray-500" >
						...
						<div class="flex bg-gray-500 p-4">
					...
					<div v-for="product_list in tax.product_detail">
						...
						<div class="flex p-4 border-t border-gray-500">
