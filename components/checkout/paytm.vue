<template>
  <div class="">
    <div class="" v-show="paymethod"><!--  w-3/4 p-8 border-r border-gray-500 -->
      <!-- <form action="#" @submit.prevent="store" enctype="multipart/form-data"> -->
        <h4 class="my-4 uppercase">Payment method</h4>
          
                       <div class="w-full flex bg-gray-100 flex-col p-8 h-70">
                          <div class="flex flex-col">      
                          <p>Pay TM</p>        
                          <a href="#" class="my-4 w-1/2 text-center no-underline p-3 rounded-full cursor-pointer btnstyle" @click="store()"
                          >Pay To PayTM</a>
